...
public interface IApiServices {
    ...
    void modifyUser(String accessToken, User user, String address, String email, String newPassword, String phone, Consumer<User> onSuccess, Consumer<ApiError> onFailure);
}
